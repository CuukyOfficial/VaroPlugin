...
public class BotLauncher {
	...
	public void startupDiscord() {
		...
		if (ConfigEntry.DISCORDBOT_TOKEN.getValue().equals("ENTER TOKEN HERE")
				|| ConfigEntry.DISCORDBOT_EVENTCHANNELID.getValueAsLong() == -1
				|| ConfigEntry.DISCORDBOT_SERVERID.getValueAsLong() == -1) {
			System.err.println(
					Main.getConsolePrefix() + "DiscordBot deactivated because of missing information in the config");
			return;
		}
		...
		try {
			...
			System.out
					.println(Main.getConsolePrefix() + "If you want to use the discordbot please install this plugin:");
	...
	public void startupTelegram() {
		...
		if (ConfigEntry.TELEGRAM_BOT_TOKEN.getValue().equals("ENTER TOKEN HERE")) {
			System.err.println(
					Main.getConsolePrefix() + "TelegramBot deactivated because of missing information in the config");
			return;
		}
		...
		try {
			...
			System.out.println(
					Main.getConsolePrefix() + "If you want to use the Telegrambot please install this plugin:");
