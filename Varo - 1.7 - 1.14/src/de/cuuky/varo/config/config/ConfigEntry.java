...
public enum ConfigEntry {
	...
	PROJECTNAME_COLORCODE(ConfigSection.MAIN, "projectnameColorcode", "&3", "Dieser Farbcode ist der MaÃgebende,\nder Ã¼berallim Projekt verwendet wird.."),
	...
	NAMETAGS(ConfigSection.MAIN, "nametags", true, "Ob das Plugin die Nametags Ã¼ber\nden KÃ¶pfen der Spieler veraendern soll.\nHinweis: du kannst diese in der messages.yml einstellen."),
	PLAY_TIME(ConfigSection.MAIN, "playTime", 15, "Zeit in Minuten, wie lange die Spieler\npro Session auf dem Server spielen kÃ¶nnen.\nUnlimited = -1"),
	DO_DAILY_BACKUPS(ConfigSection.MAIN, "dailyBackups", true, "Es werden immer Backups um 'ResetHour' gemacht."),
	UNREGISTERED_PLAYER_JOIN(ConfigSection.MAIN, "unregisteredPlayerJoin", true, "Ob unregistrierte Spieler joinen dÃ¼rfen."),
	...
	// OFFLINEVILLAGER
	OFFLINEVILLAGER(ConfigSection.OFFLINEVILLAGER, "enableOfflineVillager", false, "Ob Villager, welche representativ fÃ¼r den Spieler wÃ¤hrend\nseiner Onlinezeit auf dem Server warten und gekillt werden kÃ¶nnen."),
	NO_SATIATION_REGENERATE(ConfigSection.OFFLINEVILLAGER, "noSatiationRegenerate", false, "Ob Spieler nicht durch SÃ¤ttigung regenerieren\nkÃ¶nnen sondern nur durch Gapple etc."),

	// BACKPACKS
	BACKPACK_ALLOW(ConfigSection.BACKPACKS, "allowBackpacks", false, "Erlaubt den Spielern den Zugriff\nauf ihr Backpack mit /varo bp"),
	BACKPACK_SIZE(ConfigSection.BACKPACKS, "backpackSize", 54, "GrÃ¶Ãe der Backpacks (Max = 54)"),
	BACKPACK_ALLOW_TEAMACCESS(ConfigSection.BACKPACKS, "allowTeamAccess", true, "Ob Teampartner mit /varo vp auf den\nRucksackes Mitspielers zugreifen dÃ¼rfen"),
	...
	CANWALK_PROTECTIONTIME(ConfigSection.PROTECTIONS, "canWalkOnJoinProtection", false, "Ob Spieler waehrend der Joinschutzzeit laufen kÃ¶nnen."),
	...
	STRIKE_BAN_AFTER_STRIKE_HOURS(ConfigSection.STRIKE, "banOnPostHours", -1, "FÃ¼r wie viele Stunden die Spieler\nnach einem Strike gestriket werden"),
	...
	DO_SORT_AT_START(ConfigSection.START, "doSortAtStart", false, "Ob beim Start /sort ausgefÃ¼hrt werden soll."),
	...
	BORDER_TIME_MINUTE_DECREASE_SPEED(ConfigSection.BORDER, "minuteBorderDecrease.speed", 5, "Wie viele BlÃ¶cke pro Sekunde sichdie\nBorder nach Minuten verkleinern soll."),
	...
	BORDER_TIME_DAY_DECREASE_SPEED(ConfigSection.BORDER, "dayBorderDecrease.speed", 5, "Wie viele BlÃ¶cke pro Sekunde sich\ndie Border nach Tagen verkleinern soll."),
	...
	// CHAT
	CAN_CHAT_BEFORE_START(ConfigSection.CHAT, "canChatBeforeStart", true, "Ob die Spieler vor Start chatten kÃ¶nnen."),
	CHAT_COOLDOWN_IN_SECONDS(ConfigSection.CHAT, "chatCooldownInSeconds", 3, "Der Cooldown der Spieler im Chat,\nbevor sie wieder eine Nachricht senden kÃ¶nnen.\nOff = -1"),
	...
	NO_ACTIVITY_DAYS(ConfigSection.ACTIVITY, "noActivityDays", -1, "Nach wie vielen Tagen ohne AktivitÃ¤t auf dem\nServer der Spieler gemeldet werden soll.\nOff = -1"),
	...
	YOUTUBE_SET_OWN_LINK(ConfigSection.YOUTUBE, "setOwnLink", true, "Ob die Spieler sich selbst den\nYouTube-Link per /yt setzen dÃ¼rfen"),
	YOUTUBE_VIDEO_IDENTIFIER(ConfigSection.YOUTUBE, "videoIdentifier", "Varo", "Was die Videotitel enthalten\nmÃ¼ssen, um als Varovideo zu gelten."),

	// DISCORDBOT
	DISCORDBOT_ENABLED(ConfigSection.DISCORD, "discordBotEnabled", false, "Ob der DiscordBot fÃ¼r Events aktiviert werden soll.\nHinweis: bitte fÃ¼r diesen Informationen unten ausfÃ¼llen."),
	...
	DISCORDBOT_USE_VERIFYSTSTEM_MYSQL(ConfigSection.DISCORD, "verifySystemMySQL", false, "Ob fÃ¼r die Speicherung der BotRegister\neine MySQL Datenbank genutzt werden soll"),
	...
	DISCORDBOT_VERIFY_PASSWORD(ConfigSection.DISCORD, "mysql_verify.mysql_password", "PASSWORD_HERE", "Passwort fÃ¼r MySQL Nutzer,\nwelcher auf die Datenbank zugreifen soll"),
	...
	DISCORDBOT_RESULT_CHANNELID(ConfigSection.DISCORD, "resultChannelID", -1, "Gib hier die Channel ID an, in der spÃ¤ter\ndie Logs und die Gewinner gepostet werden sollen."),
	...
	DISCORDBOT_MESSAGE_RANDOM_COLOR(ConfigSection.DISCORD, "randomMessageColor", false, "Ob die Nachrichten eine zufÃ¤llige Farbe haben sollen"),
	...
	AUTOSETUP_BORDER(ConfigSection.AUTOSETUP, "border", 2000, "Wie groÃ die Border beim\nAutoStart gesetzt werden soll"),
	...
	AUTOSETUP_PORTAL_HEIGHT(ConfigSection.AUTOSETUP, "portal.height", 5, "HÃ¶he des gespawnten Portals"),
	AUTOSETUP_LOBBY_ENABLED(ConfigSection.AUTOSETUP, "lobby", true, "Ob eine Lobby beim AutoSetup gespawnt werden osll"),
	AUTOSETUP_LOBBY_SCHEMATIC(ConfigSection.AUTOSETUP, "lobby.schematic", "plugins/Varo/schematics/lobby.schematic", "Schreibe hier den Pfad deiner Lobby-Schematic\nhin, die gepastet werden soll.\nHinweis: WorldEdit benÃ¶tigt"),
	AUTOSETUP_LOBBY_SIZE(ConfigSection.AUTOSETUP, "lobby.size", 25, "GoeÃe der Lobby, die gespawnt werden soll"),
	AUTOSETUP_LOBBY_HEIGHT(ConfigSection.AUTOSETUP, "lobby.height", 10, "HÃ¶he der Lobby, die gespawnt werden soll"),
	AUTOSETUP_SPAWNS_RADIUS(ConfigSection.AUTOSETUP, "spawns.radius", 30, "In welchem Radius die LÃ¶cher\ngeneriert werden sollen"),
	AUTOSETUP_SPAWNS_AMOUNT(ConfigSection.AUTOSETUP, "spawns.amount", 40, "Zu welcher Anzahl die LÃ¶cher\ngeneriert werden sollen"),
	...
	DEBUG_OPTIONS(ConfigSection.OTHER, "debugOptions", false, "Ob Debug Funktionen verfÃ¼gbar sein sollen.\nVorsicht: Mit Bedacht oder nur\nauf Anweisung nutzen!");
	...
	public String getValueAsString() {
		try {
			return String.valueOf(this.value).replaceAll("&", "Â§");
		} catch(Exception e) {
			sendFalseCast();
		}
