...
public enum ConfigEntry {
	...
	CANWALK_PROTECTIONTIME(ConfigSection.PROTECTIONS, "canWalkOnJoinProtection", false, "Ob Spieler waehrend der Joinschutzzeit laufen können."),
	...
	NO_ACTIVITY_DAYS(ConfigSection.ACTIVITY, "noActivityDays", -1, "Nach wie vielen Tagen ohne Aktivität auf dem\nServer der Spieler gemeldet werden soll.\nOff = -1"),
	...
	AUTOSETUP_LOBBY_SIZE(ConfigSection.AUTOSETUP, "lobby.size", 25, "Goeße der Lobby, die gespawnt werden soll"),
