...
public enum ConfigMessages {
	...
	SERVER_MODT_NOT_OPENED("Server.motd.serverNotOpened", "&cDer Server wurde noch nicht für alle geoeffnet! %nextLine%&7Versuche es später erneut!"),
	...
	JOIN_KICK_NO_PREPRODUCES_LEFT("Join.kick.noPreproduceLeft", "&cDu hast für die naechsten %days% Tage vorproduziert! %nextLine%&7Versuche es morgen erneut"),
	...
	BORDER_DECREASE_DAYS("Border.decreaseDays", "&7Die Border wird jetzt um &c%size% &7Bloecke mit &c%speed% &7Bloecken/s verkleinert. &7Nächste Verkleinerung in &c%days% &7Tagen!"),
	BORDER_DECREASE_MINUTES("Border.decreaseMinutes", "&7Die Border wird jetzt um &c%size% &7Bloecke mit &c%speed% &7Bloecken/s verkleinert. &7Nächste Verkleinerung in &c%days% &7Minuten!"),
