...
public class CommandCommand extends DiscordBotCommand {
	...
	public CommandCommand() {
		super("command", new String[] { "consolecommand", "executecommand" }, "Fuehrt einen Command in der Konsole aus.");
	}
	...
	public void onEnable(String[] args, MessageReceivedEvent event) {
		getDiscordBot().sendMessage("Feature aufgrund der 1.7-1.14 Kompatibilitaet entfernt.", "INFO", Color.MAGENTA, event.getTextChannel());
