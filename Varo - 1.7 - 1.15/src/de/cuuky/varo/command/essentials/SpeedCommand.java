	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(args.length == 1) {
			...
			try {
				...
				sender.sendMessage(Main.getPrefix() + "§7Du hast gÃ¼ltigen keinen §bSpeed §7angegeben!");
				return false;
			}
			...
			sender.sendMessage(Main.getPrefix() + "§7Deine " + Main.getColorCode() + (p.isFlying() ? "Flug" : "Lauf") + "-Geschwindigkeit §7betrÃ¤gt nun " + args[0] + "!");
			...
			try {
				...
				sender.sendMessage(Main.getPrefix() + "§7Du hast gÃ¼ltigen keinen " + Main.getColorCode() + "Speed §7angegeben!");
				return false;
			}
			...
			if(args[1].equalsIgnoreCase("@a")) {
				...
				sender.sendMessage(Main.getPrefix() + "§7Speed erfolgreich fÃ¼r alle gesetzt!");
				return false;
			}
			...
			sender.sendMessage(Main.getPrefix() + "§7" + to.getName() + "'s " + Main.getColorCode() + (to.isFlying() ? "Flug" : "Lauf") + "-Geschwindigkeit §7betrÃ¤gt nun " + args[0] + "!");
		} else
