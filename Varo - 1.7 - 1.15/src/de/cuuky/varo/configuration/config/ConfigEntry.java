...
public enum ConfigEntry {
	...
	BORDER_TIME_MINUTE_BC_INTERVAL(ConfigSection.BORDER, "minuteBorderDecrease.bcInterval", 300, "In welchen Sekundenabständen die Zeit bis zur Verkleinerung\ngebroacastet werden soll"),
	...
	DO_SPAWN_GENERATE_AT_START(ConfigSection.START, "doSpawnGenerateAtStart", false, "Ob die Spawnlöcher am Start basierend auf den\nderzeitigen Spielern generiert werden sollen"),
	...
	STARTPERIOD_PROTECTIONTIME_BROADCAST_INTERVAL(ConfigSection.PROTECTIONS, "startperiodProtectiontimeBcInterval", 60, "In welchen Sekundenabständen die restliche Schutzzeit\ngebroacastet werden soll"),
