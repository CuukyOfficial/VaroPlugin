...
public enum ConfigEntrySection {
	...
	private ConfigEntrySection(String name, Material material, String description) {
		this.name = name;
	...
	public static ConfigEntrySection getSection(String name) {
