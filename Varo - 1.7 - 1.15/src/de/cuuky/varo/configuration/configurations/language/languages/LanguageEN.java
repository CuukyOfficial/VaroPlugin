...
public enum LanguageEN implements LoadableMessage {
	...
	SORT_NO_HOLE_FOUND("sort.noHoleFound", "No hole could be found for you!"),
	SORT_NO_HOLE_FOUND_TEAM("sort.noHoleFoundTeam", "No hole could be found for you beside your team partners."),
	SORT_NUMBER_HOLE("sort.numberHoleTeleport", "You have been teleported to the hole %colorcode%%number% &7!"),
	SORT_OWN_HOLE("sort.ownHoleTeleport", "You've been put in your hole!"),
	SORT_SPECTATOR_TELEPORT("sort.spectatorTeleport", "You were teleported to spawn because you're a spectator!"),
	...
	TEAMREQUEST_MAX_TEAMNAME_LENGTH("teamrequest.maxTeamnameLength", "Your team name must not contain more than %colorcode%%maxLength% &7characters!"),
	TEAMREQUEST_NO_COLORCODE("teamrequest.noColorCode", "Your team name must not contain color codes!"),
	TEAMREQUEST_NO_HASHTAG("teamrequest.noHashtag", "Your team name must not contain a '#'. (Will be added automatically)"),
