...
public enum ConfigMessageSection implements SectionConfiguration {
	...
	CHEST("chest", "Nachrichten zum Sichern von Kisten & Öfen"),
...
//	COMMANDS("commands", "Nachrichten zu den Befehlen"), 
	...
	SPAWNS("spawns", "Nachrichten für die Spawns"),
	PROTECTION("protection", "Nachrichten für die Schutzzeiten"),
	...
	NOPERMISSION("nopermission", "Nachrichten für unzureichende Berechtigungen"),
	QUITMESSAGE("quitmessage", "Nachrichten für das Verlassen des Servers"),
