...
public enum ConfigMessages implements DefaultLanguage {
	...
	QUIT_KICK_SERVER_CLOSE_SOON_GLOBAL("quitmessage.serverCloseSoonGlobal", "&7Der Server schließt in &c%minutes% &7Minuten!"),
	QUIT_KICK_SERVER_CLOSE_SOON_PLAYER("quitmessage.serverCloseSoonLocal", "&7Der Server schließt für dich in &c%minutes% &7Minuten!"),
	...
	SERVER_MODT_CANT_JOIN_GLOBAL("motd.cantJoinGlobal", "&cDu kannst nur zwischen &4%minHour%:%minMinute% &cund &4%maxHour%:%maxMinute%&c Uhr joinen! %nextLine%&cDas ist in deiner Zeitzone &4%minPlayerHour%:%minPlayerMinute% &c- &4%maxPlayerHour%:%maxPlayerMinute%&c Uhr! %nextLine%&7Versuche es später erneut! &7%currPlayerHour%&7:&7%currPlayerMin%&7:&7%currPlayerSec%"),
	SERVER_MODT_CANT_JOIN_PLAYER("motd.cantJoinPlayer", "&cDu kannst nur zwischen &4%minHour%:%minMinute% &cund &4%maxHour%:%maxMinute%&c Uhr joinen! %nextLine%&7Versuche es später erneut! &7%currPlayerHour%&7:&7%currPlayerMin%&7:&7%currPlayerSec%"),
	...
	VARO_COMMANDS_AUTOSTART_INFO_RANDOM_TEAM_SIZE("varoCommands.autostart.info.randomteamsize", "%colorcode%AutoRandomteamgröße: &7%teamsize%"),
	...
	VARO_COMMANDS_RANDOMTEAM_HELP("varoCommands.randomteam.help", "%colorcode%/varo randomTeam <Teamgröße>"),
	VARO_COMMANDS_RANDOMTEAM_TEAMSIZE_TOO_SMALL("varoCommands.randomteam.teamsizetoosmall", "&7Die Teamgröße muss mindestens 1 betragen."),
	...
	VARO_COMMANDS_RANDOMTEAM_NO_PARTNER("varoCommands.randomteam.sorted", "&7Für dich konnten nicht genug Teampartner gefunden werden."),
	...
	VARO_COMMANDS_DISCORD_GETLINK("varoCommands.discord.getlink", "&7Der Discord Account von %colorcode%%player% heißt %colorcode%%user%&7 und die ID lautet %colorcode%%id%&7!"),
