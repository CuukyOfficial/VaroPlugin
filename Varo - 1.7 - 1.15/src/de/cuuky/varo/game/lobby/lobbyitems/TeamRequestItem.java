...
public class TeamRequestItem extends LobbyItem {
	...
	public TeamRequestItem() {
		super(new ItemBuilder().lore(new String[] { "ß7Mit diesem Item kannst du Spieler schlagen", "ß7woraufhin sie in dein Team eingeladen werden!" }).itemstack(new ItemStack(Material.DIAMOND_SWORD)).displayname(Main.getColorCode() + "Schlagen ß7f√ºr Team").build(), 0);
	}
