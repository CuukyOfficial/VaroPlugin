...
public class OutSideTimeChecker {
	...
	private void refreshDates() {
		...
		date1.set(GregorianCalendar.MINUTE, ConfigEntry.ONLY_JOIN_BETWEEN_HOURS_MINUTE1.getValueAsInt());
		date2.set(GregorianCalendar.HOUR_OF_DAY, ConfigEntry.ONLY_JOIN_BETWEEN_HOURS_HOUR2.getValueAsInt());
		date2.set(GregorianCalendar.MINUTE, ConfigEntry.ONLY_JOIN_BETWEEN_HOURS_MINUTE2.getValueAsInt());
