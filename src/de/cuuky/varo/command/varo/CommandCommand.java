...
public class CommandCommand extends VaroCommand {
    private static final String[] subCommands = {"create", "edit", "help", "info", "list", "remove"};
    private final PageableChatBuilder<CustomCommand> builder;

    public CommandCommand() {
        super("command", "Erstelle eigene Befehle", "varo.command", subCommands);
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 3 && args[1].equalsIgnoreCase("edit")) {
            String[] subCommands = {"description", "name", "output", "deactivated", "permission"};
