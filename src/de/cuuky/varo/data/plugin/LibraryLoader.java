...
public class LibraryLoader {
	...
	static {
		LIBRARIES.add(new JarLibrary("JDA-5.0.0-alpha.9", "net.dv8tion.jda.api.JDABuilder",
				"https://repo1.maven.org/maven2/net/dv8tion/JDA/5.0.0-alpha.9/JDA-5.0.0-alpha.9.jar",
