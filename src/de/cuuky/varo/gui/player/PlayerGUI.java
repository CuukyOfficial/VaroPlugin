...
public class PlayerGUI extends VaroInventory {
    ...
    public void refreshContent() {
        ...
        addItem(1, ItemBuilder.material(XMaterial.DIAMOND_CHESTPLATE).displayName("§aInventory Backups").lore("§7Click to see more options").build(),
        ...
        addItem(7, ItemBuilder.material(XMaterial.CHEST).displayName("§eChests/Furnaces")
        ...
        addItem(11, ItemBuilder.material(XMaterial.RED_DYE).displayName("§4Remove").build(),
        ...
        addItem(15, ItemBuilder.material(XMaterial.SKELETON_SKULL).displayName("§cReset").build(),
