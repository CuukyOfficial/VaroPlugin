...
public class VaroConfig {
    ...
    private static final Config DEBUG_CONFIG = YamlConfig.of(new File("plugins/Varo/config/debug.yml"), "DO NOT EDIT THIS FILE UNLESS YOU ARE SPECIFICALLY TOLD TO DO SO BY THE DEVELOPERS!");
    public static final BooleanConfigEntry MESSAGES_ENABLE_CONSTEXPR_EVAL = BooleanConfigEntry.of(DEBUG_CONFIG, "messages.enableConstexprEval", true);
    public static final BooleanConfigEntry MESSAGES_ENABLE_INLINE = BooleanConfigEntry.of(DEBUG_CONFIG, "messages.enableInline", true);
