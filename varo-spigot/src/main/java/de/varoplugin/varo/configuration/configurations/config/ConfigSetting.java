...
import de.varoplugin.varo.configuration.configurations.SectionEntry;
...
public enum ConfigSetting implements SectionEntry {
	...
	DISCORDBOT_ADD_TROPHY_ON_WIN(ConfigSettingSection.DISCORD, "addTrophyOnWin", false, "Ob den Gewinnern Pokale hinter den\nNamen gesetzt werden sollen."),
	...
	TABLIST_FOOTER_UPDATEDELAY(ConfigSettingSection.HUD, "tablist.footer.updatedelay", 100, "Das Intervall in Ticks mit dem der Footer der Tablist aktualisiert werden soll."),
	...
	SCOREBOARD_TITLE_UPDATEDELAY(ConfigSettingSection.HUD, "scoreboard.title.updatedelay", 100, "Das Intervall in Ticks in mit dem der Titel des Scoreboards aktualisiert werden soll."),
